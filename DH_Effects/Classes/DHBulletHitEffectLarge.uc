...
defaultproperties
{
    ...
    HitEffects(3)=(HitDecal=class'BulletHoleMetal',HitEffect=class'DHBulletHitMetalEffectLarge',HitSound=Sound'ProjectileSounds.PTRD_penetrate')                // Metal
    ...
    HitEffects(15)=(HitDecal=class'BulletHoleMetalArmor',HitEffect=class'DHBulletHitMetalArmorEffectLarge',HitSound=Sound'ProjectileSounds.PTRD_deflect')       // MetalArmor
    ...
    HitEffects(19)=(HitDecal=class'BulletHoleDirt',HitEffect=class'DHBulletHitMudEffectLarge',HitSound=Sound'ProjectileSounds.Bullets.Impact_Mud')              // Poop
