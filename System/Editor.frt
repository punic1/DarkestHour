...
Preferences="(Caption="Avancé",Parent="Editeur",Class=Editor.EditorEngine,Immediate=True,Category=Advanced)"
...
Preferences="(Caption="Grille - rotation",Parent="Editeur",Class=Editor.EditorEngine,Immediate=True,Category=RotationGrid)"
...
HelpCmd="mapconvert"
HelpOneLiner="Convertit cartes nouveau format (sans transform. pinceau)"
HelpUsage="mapconvert SrcFilename DstFilename"
HelpParm[0]="SrcFilename"
HelpDesc[0]="Nom fichier carte à lire"
HelpParm[1]="DstFilename"
HelpDesc[1]="Nom fichier carte où écrire"
...
HelpDesc[2]="Ne pas afficher les messages 'Analyse' & 'Compilation' pour chaque classe"
HelpParm[3]="exportcache"
HelpDesc[3]="Création de fichiers caches pour le package compilé"
...
HelpOneLiner="Etab. drapeaux de package ds fich. de package"
HelpUsage="packagedrapeau src.ext [dest.ext <+|->drapeau [<+|->drapeau] ...]"
HelpParm[0]="src.ext"
HelpDesc[0]="Fich. de package exist. à charger"
HelpParm[1]="dest.exe"
HelpDesc[1]="Nom nouv. fich. de package avec nouv. param. drapeau"
HelpParm[2]="drapeau"
...
HelpOneLiner="Analyse carte"
HelpUsage="analyzecontent mapname"
HelpParm[0]="mapname"
HelpDesc[0]="Chem. v. fich. carte"
