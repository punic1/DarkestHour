...
PackageResolveFailed="Imp. résoudre nom de package"
FilenameToPackage="Imposs. convertir nom '%s' vers nom de package"
...
NotDll="'%s' n'est pas un package DLL ; export '%s' introuvable"
NotInDll="%s' introuv. dans '%s.dll'"
FailedLoadPackage="Echec charg. package : %s"
...
NotPackaged="Objet hors package : %s %s"
...
OverwriteReadOnly="'%s' est en lecture seule. Voulez-vous essayer de l'écraser tout de même ?"
CheckoutPerforce="'%s' est en lecture seule.  Voulez-vous essayer de le sortir de Perforce ?"
