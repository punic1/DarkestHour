...
[General]
Upgrade=Pour entrer sur ce serveur, vous devez avoir les dernières mise à jour de Red Orchestra, disponibles gratuitement sur le site internet de Tripwire :
...
ACDisplayText[1]="Politique d'accès"
...
Msg_AllGameMaps="Les cartes valides (peuvent être ajoutées) à"
...
Msg_NoMapsAdded="Pas de carte ajoutée à la liste de cartes %maplist%."
Msg_AddedMapToList="Cartes ajoutées à la liste de cartes"
Msg_NoMapsRemoved="Aucune carte retirée de la liste de cartes %maplist%."
Msg_RemovedFromList="Cartes retirées de la liste de cartes"
...
Msg_NextMapNotFound="Carte suivante introuvable ; relance de la même carte"
Msg_ChangingMapTo="Changement de carte pour %NextMap%"
Msg_NoMapInRotation="Pas de cartes configurées pour %maplist%."
Msg_NoMapsFound="Cartes correspondant à la liste de cartes %maplist% introuvables."
...
Msg_MapListAdded="Liste de cartes %listname% ajoutée au type de partie"
Msg_MapListRemoved="Liste de cartes %listname% retirée du type de partie"
...
BHDisplayText[1]="Séparer spectateurs"
...
GIPropDescText[4]="Définir le nombre maximum de spectateurs de la partie."
GIPropDescText[5]="Définir le nombre maximum de joueurs pouvant rejoindre ce serveur."
...
GIPropDescText[8]="La partie s'arrête après la durée indiquée (en minutes)."
...
GIPropsExtras[0]="0.000000;Inexpérimenté;1.000000;Nouvelle recrue;2.000000;Bleu;3.000000;Soldat du front;4.000000;Soldat expérimenté;5.000000;Vétéran;6.000000;Héros de guerre;7.000000;Fanatique"
NoBindString="[Rien]"

[GameMessage]
SwitchLevelMessage="Chang. niveau"
LeftMessage=" est parti(e)."
FailedTeamMessage="Imposs. trouv. équipe joueur"
FailedPlaceMessage="Imposs. trouver pt de départ"
FailedSpawnMessage="Imposs. régén. joueur"
EnteredMessage=" entré(e) ds part."
MaxedOutMessage="Serv. déjà à pleine capacité."
...
KickVoteGroup="Vote éjection"

[LevelInfo]
Title="Sans titre"

[MaplistManager]
DefaultListName="Par défaut"
...
VCDescText[1]="Déterminer si le canal de discussion orale 'local' est créé, ce qui permet aux joueurs d'envoyer des messages vocaux aux joueurs se trouvant à proximité."
...
VCDescText[4]="Configurer les codecs du serveur qui doivent être utilisés dans les parties internet."
VCDescText[5]="Configurer les codecs du serveur qui doivent être utilisés dans les parties LAN."
